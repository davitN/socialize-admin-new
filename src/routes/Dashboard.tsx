    ...
    switch (chartPeriod) {
      case 'YEARLY':
        if (dashboardData.busiestDayLastYear) {
          setBusiestDay(
            `${weekDays[dashboardData?.busiestDayLastYear?._id - 1]} (${
              dashboardData?.busiestDayLastYear?.count
            })`
          );
        } else {
          setBusiestDay(' ');
        ...
        setRenderedChart(
          <StackedColumnChartYear
            incomeData={dashboardData?.customerTrendsThrowYear || null}
          />
        );
        break;
      case 'MONTHLY':
        if (dashboardData.busiestDayLastMonth) {
          setBusiestDay(
            `${weekDays[dashboardData?.busiestDayLastMonth?._id - 1]} (${
              dashboardData?.busiestDayLastMonth?.count
            })`
          );
        } else {
          setBusiestDay(' ');
        ...
        setRenderedChart(
          <StackedColumnChartMonth
            incomeData={dashboardData?.customerTrendsThrowMonth || null}
          />
        );
        break;
      case 'WEEKLY':
        if (dashboardData.busiestDayLastWeek) {
          setBusiestDay(
            `${weekDays[dashboardData?.busiestDayLastWeek?._id - 1]} (${
              dashboardData?.busiestDayLastWeek?.count
            })`
          );
        } else {
          setBusiestDay(' ');
        ...
        setRenderedChart(
          <StackedColumnChartWeek
            incomeData={dashboardData?.customerTrendsThrowWeek || null}
          />
        );
        break;
    }
          ...
          <Container fluid>
            ...
            <Row>
              <Col xl="4">
                ...
                />
                <MonthlyEarning dashbordData={dashboardData} />
              </Col>
              <Col xl="8">
                <Row>
                  {/* Reports Render */}
